...
n_epochs = 51
device = "cuda:1"
model_path = "/home/denis/src/project/models/classification/dog_muzzle_len/mobilenetv3_large_100_augs_high_res_strat_video_split_v2"
...
experiment = {
    ...
    "name": "dog_muzzle_len_" + split(model_path)[-1],
}
...
train_data = {
    ...
    "ann_file": "/home/denis/nkbtech/data/Dog_expo_Vladimir_02_07_2023_mp4_frames/multiclass_v4/annotation_dog_muzzle_len_high_res_strat_video_split_v2.csv",
